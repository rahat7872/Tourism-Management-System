...
<a style="float:right" href="admin.php">Admin</a>
  ...
  <div class="column">
   ...
   <h2 style="text-align:center;font-size:40px">Contact Information </h2>
<div class="contact">
 <p><i class="fas fa-at"></i> <b>Email:</b> <a href="#">tourismmanagement088@gmail.com</a></p>
 <p> <i class="fas fa-address-book"></i> <b>Address:</b> Motijheel 12/1,Dhaka,Bangladesh</p>
 <p><i class="fas fa-phone"></i> <b>Phone:</b><a href="#"> +880 016210501549 ,  +880 019201080150  </a></p>
 
  <a href="register.php" class="w3-button w3-teal" >Register</a>
