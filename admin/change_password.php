...
<div class="topnav">
  <a   href="home.php">Dashboard</a>
    <a class="active"    href="change_password.php">Profile</a>
...
<?php
				  ...
				  $query1=mysqli_query($connection,"select * from admin where UserName='$username'");
...
?>
				...
				<p>
                  ...
                  <input class="w3-input w3-light-grey w3-animate-input" type="text" name="username" value="<?php echo $na?>" readonly >
                </p>
